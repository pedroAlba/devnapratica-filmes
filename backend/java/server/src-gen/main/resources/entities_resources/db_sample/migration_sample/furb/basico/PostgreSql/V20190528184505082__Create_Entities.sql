/* Database: PostgreSql. Generation date: 2019-05-28 18:45:05:082 */
/* Entity Cliente */
...
alter table pedido add constraint fkh46nzbd8zsclhgjh0al992btjwsn foreign key (cliente) references cliente (id);
alter table pedido_itens add constraint fkjhaqnorymbsb7aogrbmkgjjqae9k foreign key (pedido_id) references pedido (id);
alter table pedido_itens add constraint fkddbn3okiow4osjvyanhxaywmxzmk foreign key (itens_id) references item (id);
