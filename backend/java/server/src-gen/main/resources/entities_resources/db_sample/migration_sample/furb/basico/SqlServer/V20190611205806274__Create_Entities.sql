/* Database: SqlServer. Generation date: 2019-06-11 20:58:06:274 */
/* Entity Cliente */
...
alter table pedido add constraint fk5aawb8xk0mnvwas692bmm3ihsl3f foreign key (cliente) references cliente (id);
alter table pedido_itens add constraint fklauuvn8m7lq08y7v4bw0dkluujgb foreign key (pedido_id) references pedido (id);
alter table pedido_itens add constraint fkb41xitfsy22zxsvjpvhgfwqb5jgs foreign key (itens_id) references item (id);
