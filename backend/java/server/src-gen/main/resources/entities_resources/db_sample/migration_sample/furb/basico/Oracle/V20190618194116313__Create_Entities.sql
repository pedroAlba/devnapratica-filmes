/* Database: Oracle. Generation date: 2019-06-18 19:41:16:313 */
/* Entity Cliente */
...
alter table pedido add constraint fk0z9ikeqtchchaek5flw7j2tm9zsg foreign key (cliente) references cliente (id);
alter table pedido_itens add constraint fk6ixj1dt6naesondu0ueabiwnsijn foreign key (pedido_id) references pedido (id);
alter table pedido_itens add constraint fkbmvomqnqkfi4q3f1xhdsxfjceuki foreign key (itens_id) references item (id);
