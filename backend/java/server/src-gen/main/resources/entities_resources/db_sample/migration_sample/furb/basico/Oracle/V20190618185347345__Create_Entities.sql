/* Database: Oracle. Generation date: 2019-06-18 18:53:47:345 */
/* Entity Cliente */
...
alter table pedido add constraint fk9ukoy6tayt3nxxv1getjsub5gjac foreign key (cliente) references cliente (id);
alter table pedido_itens add constraint fkl0jsdqtqyho0mpvin4zthgmbkfbl foreign key (pedido_id) references pedido (id);
alter table pedido_itens add constraint fkkpggs88rjvegv1zleinxjgqdejim foreign key (itens_id) references item (id);
