 ...
 * 
 */
public class CreateBulkGeneroImpl {
	...
	public CreateBulkGeneroImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkGeneroInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_GENERO, //
	...
	*/
	public CreateBulkGeneroOutput createBulkGenero(CreateBulkGeneroInput input, long timeout) {
		...
		CreateBulkGeneroOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkGeneroOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkGeneroOutput> createBulkGeneroRequest(CreateBulkGeneroInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkGeneroOutput.class);
	}
