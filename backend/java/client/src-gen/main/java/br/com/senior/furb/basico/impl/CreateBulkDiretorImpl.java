 ...
 * 
 */
public class CreateBulkDiretorImpl {
	...
	public CreateBulkDiretorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkDiretorInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_DIRETOR, //
	...
	*/
	public CreateBulkDiretorOutput createBulkDiretor(CreateBulkDiretorInput input, long timeout) {
		...
		CreateBulkDiretorOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkDiretorOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkDiretorOutput> createBulkDiretorRequest(CreateBulkDiretorInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkDiretorOutput.class);
	}
