...
public class ImportAtorOutput {
    
    public String importJobId;
    
    public ImportAtorOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportAtorOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportAtorOutput)) {
            return false;
        }
        ImportAtorOutput other = (ImportAtorOutput) obj;
