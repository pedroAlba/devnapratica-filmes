...
public class ExportGeneroOutput {
    
    public String exportJobId;
    
    public ExportGeneroOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportGeneroOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportGeneroOutput)) {
            return false;
        }
        ExportGeneroOutput other = (ExportGeneroOutput) obj;
