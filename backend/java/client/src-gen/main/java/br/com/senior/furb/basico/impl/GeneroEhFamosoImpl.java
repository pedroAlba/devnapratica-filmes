 ...
 * 
 */
public class GeneroEhFamosoImpl {
	...
	public GeneroEhFamosoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(GeneroEhFamosoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.GENERO_EH_FAMOSO, //
	...
	*/
	public GeneroEhFamosoOutput generoEhFamoso(GeneroEhFamosoInput input, long timeout) {
		...
		GeneroEhFamosoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), GeneroEhFamosoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<GeneroEhFamosoOutput> generoEhFamosoRequest(GeneroEhFamosoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, GeneroEhFamosoOutput.class);
	}
