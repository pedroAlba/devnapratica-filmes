 ...
 * 
 */
public class TrocaDiretorFilmeImpl {
	...
	public TrocaDiretorFilmeImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(TrocaDiretorFilmeInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.TROCA_DIRETOR_FILME, //
	...
	*/
	public TrocaDiretorFilmeOutput trocaDiretorFilme(TrocaDiretorFilmeInput input, long timeout) {
		...
		TrocaDiretorFilmeOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), TrocaDiretorFilmeOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<TrocaDiretorFilmeOutput> trocaDiretorFilmeRequest(TrocaDiretorFilmeInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, TrocaDiretorFilmeOutput.class);
	}
