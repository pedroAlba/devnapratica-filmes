 ...
 * 
 */
public class CreateBulkFilmeImpl {
	...
	public CreateBulkFilmeImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkFilmeInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_FILME, //
	...
	*/
	public CreateBulkFilmeOutput createBulkFilme(CreateBulkFilmeInput input, long timeout) {
		...
		CreateBulkFilmeOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkFilmeOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkFilmeOutput> createBulkFilmeRequest(CreateBulkFilmeInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkFilmeOutput.class);
	}
