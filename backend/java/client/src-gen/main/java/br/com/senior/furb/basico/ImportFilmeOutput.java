...
public class ImportFilmeOutput {
    
    public String importJobId;
    
    public ImportFilmeOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportFilmeOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportFilmeOutput)) {
            return false;
        }
        ImportFilmeOutput other = (ImportFilmeOutput) obj;
