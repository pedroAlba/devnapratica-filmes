 ...
 * 
 */
public class RetornaFilmesByAtorImpl {
	...
	public RetornaFilmesByAtorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(RetornaFilmesByAtorInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.RETORNA_FILMES_BY_ATOR, //
	...
	*/
	public RetornaFilmesByAtorOutput retornaFilmesByAtor(RetornaFilmesByAtorInput input, long timeout) {
		...
		RetornaFilmesByAtorOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), RetornaFilmesByAtorOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<RetornaFilmesByAtorOutput> retornaFilmesByAtorRequest(RetornaFilmesByAtorInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, RetornaFilmesByAtorOutput.class);
	}
