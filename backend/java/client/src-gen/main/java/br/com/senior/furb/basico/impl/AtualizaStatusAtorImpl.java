 ...
 * 
 */
public class AtualizaStatusAtorImpl {
	...
	public AtualizaStatusAtorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(AtualizaStatusAtorInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.ATUALIZA_STATUS_ATOR, //
	...
	*/
	public AtualizaStatusAtorOutput atualizaStatusAtor(AtualizaStatusAtorInput input, long timeout) {
		...
		AtualizaStatusAtorOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), AtualizaStatusAtorOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<AtualizaStatusAtorOutput> atualizaStatusAtorRequest(AtualizaStatusAtorInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, AtualizaStatusAtorOutput.class);
	}
