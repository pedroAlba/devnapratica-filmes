...
public class ExportDiretorOutput {
    
    public String exportJobId;
    
    public ExportDiretorOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportDiretorOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportDiretorOutput)) {
            return false;
        }
        ExportDiretorOutput other = (ExportDiretorOutput) obj;
