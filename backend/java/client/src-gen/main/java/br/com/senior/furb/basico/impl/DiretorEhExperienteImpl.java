 ...
 * 
 */
public class DiretorEhExperienteImpl {
	...
	public DiretorEhExperienteImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(DiretorEhExperienteInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.DIRETOR_EH_EXPERIENTE, //
	...
	*/
	public DiretorEhExperienteOutput diretorEhExperiente(DiretorEhExperienteInput input, long timeout) {
		...
		DiretorEhExperienteOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), DiretorEhExperienteOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<DiretorEhExperienteOutput> diretorEhExperienteRequest(DiretorEhExperienteInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, DiretorEhExperienteOutput.class);
	}
