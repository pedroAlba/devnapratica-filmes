...
public class ImportDiretorOutput {
    
    public String importJobId;
    
    public ImportDiretorOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportDiretorOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportDiretorOutput)) {
            return false;
        }
        ImportDiretorOutput other = (ImportDiretorOutput) obj;
