...
public class ImportGeneroOutput {
    
    public String importJobId;
    
    public ImportGeneroOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportGeneroOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportGeneroOutput)) {
            return false;
        }
        ImportGeneroOutput other = (ImportGeneroOutput) obj;
