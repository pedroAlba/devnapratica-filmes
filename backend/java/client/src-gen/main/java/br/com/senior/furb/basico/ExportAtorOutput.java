...
public class ExportAtorOutput {
    
    public String exportJobId;
    
    public ExportAtorOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportAtorOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportAtorOutput)) {
            return false;
        }
        ExportAtorOutput other = (ExportAtorOutput) obj;
