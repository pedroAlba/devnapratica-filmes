...
public class ExportFilmeOutput {
    
    public String exportJobId;
    
    public ExportFilmeOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportFilmeOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportFilmeOutput)) {
            return false;
        }
        ExportFilmeOutput other = (ExportFilmeOutput) obj;
