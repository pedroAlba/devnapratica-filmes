 ...
 * 
 */
public class ExportDiretorImpl {
	...
	public ExportDiretorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportDiretorInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.EXPORT_DIRETOR, //
	...
	*/
	public ExportDiretorOutput exportDiretor(ExportDiretorInput input, long timeout) {
		...
		ExportDiretorOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportDiretorOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ExportDiretorOutput> exportDiretorRequest(ExportDiretorInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportDiretorOutput.class);
	}
