 ...
 * 
 */
public class AdicionaAtorAoFilmeImpl {
	...
	public AdicionaAtorAoFilmeImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(AdicionaAtorAoFilmeInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.ADICIONA_ATOR_AO_FILME, //
	...
	*/
	public AdicionaAtorAoFilmeOutput adicionaAtorAoFilme(AdicionaAtorAoFilmeInput input, long timeout) {
		...
		AdicionaAtorAoFilmeOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), AdicionaAtorAoFilmeOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<AdicionaAtorAoFilmeOutput> adicionaAtorAoFilmeRequest(AdicionaAtorAoFilmeInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, AdicionaAtorAoFilmeOutput.class);
	}
