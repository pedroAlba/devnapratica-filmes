 ...
 * 
 */
public class CreateBulkAtorImpl {
	...
	public CreateBulkAtorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkAtorInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_ATOR, //
	...
	*/
	public CreateBulkAtorOutput createBulkAtor(CreateBulkAtorInput input, long timeout) {
		...
		CreateBulkAtorOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkAtorOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkAtorOutput> createBulkAtorRequest(CreateBulkAtorInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkAtorOutput.class);
	}
